...
class Constants {
  ...
  static const String ORDER_STATUS_PLACED = 'PLACED';
  static const String ORDER_STATUS_CONFIRMED = 'CONFIRMED';
  static const String ORDER_STATUS_PACKED = 'PACKED';
  static const String ORDER_STATUS_TRANSIT = 'IN-TRANSIT';
  static const String ORDER_STATUS_DELIEVERED = 'DELIEVERED';
