          ...
          child: LayoutBuilder(
            builder: (context, constraints) {
              if (constraints.maxHeight > 800) {
                ...
                return HomeMobileLayout(model: model);
              }
            },
          ),
        ),
...
class HomeTabLayout extends StatefulWidget {
  @override
  _HomeTabLayoutState createState() => _HomeTabLayoutState();
}
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                          image: DecorationImage(
                            image: AssetImage("assets/images/sample_banner_1.jpg"),
                            fit: BoxFit.cover,
                          )),
                    ),
                  ),
                ...
                Container(
                  ...
                  child: Card(
                    child: Container(
                      decoration: BoxDecoration(
                          image: DecorationImage(
                            image: AssetImage("assets/images/sample_banner_2.jpg"),
                            fit: BoxFit.cover,
                          )),
                    ),
                  ),
                ...
                Container(
                  ...
                  child: Card(
                    child: Container(
                      decoration: BoxDecoration(
                          image: DecorationImage(
                            image: AssetImage("assets/images/sample_banner_3.png"),
                            fit: BoxFit.fill,
                          )),
                    ),
                  ),
...
//                          mainAxisSpacing: 10,
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: (){
//                      Navigator.of(context).pushNamed(RouteGenerator.categoryDetailsPage);
                    },
                    child: Container(
...
//                                  color: Colors.white60,
                          ...
                          const Text(
                            'n',
                            style:
                            TextStyle(color: Color(0xffEEEEEE), fontSize: 20),
                          ),
                        ],
                      ),
                    ),
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Icon(CustomIcon.male_icon,
                            size: 55, color: Color(0xD9EEEEEE)),
                        SizedBox(
                          height: 4,
                        ),
                        const Text(
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Icon(CustomIcon.male_icon,
                            size: 55, color: Color(0xffEEEEEE)),
                        SizedBox(
                          height: 4,
                        ),
                        const Text(
