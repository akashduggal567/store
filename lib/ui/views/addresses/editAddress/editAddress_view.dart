...
//                                        await pr.show();
//                                        model.navigateToBillingScreen(json.encode({
//                                          'barcode': barcodeController.text,
//                                        })).then((value) => pr.hide());
//                          widget.model.isBusy ? pr.show(): pr.hide();

//                        widget.model.navigateToLanguagPrefView(User(
//                            firstName: firstNameController.text,
//                            lastName: lastNameController.text,
//                            dateOfBirth: dOBController.text,
//                            gender: dropdownGenderValue,
//                            location: dropdownLocationValue,
//                            firebaseId: widget.user.toJson()['firebase_id'],
//                            mobileNumber: widget.user.toJson()['mobileNumber']
//                        ));
