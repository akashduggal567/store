...
class EditAddressView extends StatefulWidget {
  Address address;
  EditAddressView({@required this.address});
...
class _EditAddressViewState extends State<EditAddressView> {
  ...
  void initState() {
    ...
    super.initState();
    langitudeController.text = widget.address.latitude;
    longitudeController.text = widget.address.longitude;
    initAddressType = defaultDropdownAddressTypeValue = widget.address.addressType;
    fullNameController.text = widget.address.fullName;
    mainAddressController.text = widget.address.primaryAddress;
    streetAddressController.text = widget.address.secondaryAddress;
    landmarkController.text = widget.address.landmark;
    mobileNumberController.text = widget.address.mobileNumber;
    defaultDropdownCityValue = widget.address.city;
...
//                        model.navigateToPhoneLoginScreen();
                                      ...
                                      if (_formKey.currentState
                                        ...
                                        model.compareAndUpdate(
                                            prevAddressDetails: widget.address,
